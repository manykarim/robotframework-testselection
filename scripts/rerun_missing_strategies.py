#!/usr/bin/env python3
"""Rerun kmedoids, dpp, facility experiments that previously failed."""
...
def main():
    ...
    print("=" * 60)
    print("RERUNNING: kmedoids, dpp, facility")
    print("=" * 60)
    ...
    # Remove old failed entries for these strategies
    existing = [
        r for r in existing
        if r["strategy"] not in STRATEGIES or r["coverage_pct"] > 0
    ]
